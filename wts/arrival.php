<?php
/**
 * 入庫処理システム v3.1 - 改善実装版（統一ヘッダー正しく適用）
 * 仕様書完全準拠・モダンミニマルデザイン
 */
...
// ページ設定
function getPageConfiguration($page_id) {
    $configs = [
        'arrival' => [
            'title' => '入庫処理',
            'icon' => 'sign-in-alt',
            ...
            'subtitle' => 'Step 5/7 - 業務終了時の車両入庫処理'
        ]
    ];
    return $configs[$page_id] ?? $configs['arrival'];
}
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="system-title">福祉輸送管理システム v3.1</h1>
                        <small class="system-category"><?= $page_config['category'] ?></small>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <span class="user-name me-3"><?= htmlspecialchars($user_name) ?></span>
