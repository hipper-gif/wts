...
$summary_sql = "SELECT 
    ...
    COALESCE(SUM(r.passenger_count), 0) as total_passengers,
    COALESCE(SUM(r.fare + COALESCE(r.charge, 0)), 0) as total_revenue,
    COALESCE(AVG(r.fare + COALESCE(r.charge, 0)), 0) as avg_fare,
    ...
    COALESCE(SUM(CASE WHEN r.payment_method = '現金' THEN r.fare + COALESCE(r.charge, 0) ELSE 0 END), 0) as cash_total,
    COALESCE(SUM(CASE WHEN r.payment_method = 'カード' THEN r.fare + COALESCE(r.charge, 0) ELSE 0 END), 0) as card_total
    FROM ride_records r 
    WHERE " . implode(' AND ', $where_conditions);
...
$category_sql = "SELECT 
    ...
    COALESCE(SUM(r.fare + COALESCE(r.charge, 0)), 0) as revenue
    FROM ride_records r 
    WHERE " . implode(' AND ', $where_conditions) . "
